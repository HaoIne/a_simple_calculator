...
void get_infix_ex(Expression_elements *infix_ex) {
    ...
    l_infix_ex=index_infix_ex;

    // Debugging expressions
    for(int i=0;i<l_infix_ex;i++) {
...
void turn_to_rpn(const Expression_elements *infix_ex, Expression_elements *rpn) {
    ...
    for(index_infix_ex=0;index_infix_ex<l_infix_ex;index_infix_ex++) {
        // Process the numbers.
...
double compute_rpn(const Expression_elements *rpn) {
    ...
    for(int index_rpn = 0;index_rpn<l_rpn;index_rpn++) {
